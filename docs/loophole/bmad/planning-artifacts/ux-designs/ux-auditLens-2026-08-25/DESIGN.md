...
- **Таблица** — sticky thead, th mono uppercase 10.5px, td 13.25px; сортировка — кнопка с `aria-sort`; строка не является гигантским чекбоксом: выделение — только чекбоксом, клик по строке раскрывает детали. Отдельная кнопка-стрелка с мишенью ≥28px дублирует действие для клавиатуры и явной подсказки.
