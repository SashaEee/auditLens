# Справка к задаче про второй источник отзывов

Это не ТЗ, а подробный разбор кода к нему. Само задание: `docs/TZ_reviews_second_source.md`.
Здесь то, что нужно, только если застрял: устройство проекта, разбор витрины,
типовые ошибки на этом коде, расширенные критерии.
