...
_ALIAS = {
    ...
    # переименования на площадке (см. bankiru_fts.BANK_RENAMES): старое имя
    # ведёт на новое, иначе выбор старого показывал бы обрыв истории
    "точка": "Точка Банк", "sbi bank": "SBI Банк", "а7 финансы псб": "А7 Финансы - ПСБ",
    "долинск": "Долинск Банк",
    "банк псб": "ПСБ", "промсвязьбанк": "ПСБ",   # так ПСБ назван на sravni
