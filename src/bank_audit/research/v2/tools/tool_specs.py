...
SEARCH_REVIEWS_DB = ToolSpec(
    ...
    description=(
        ...
        "⚠ Для КОНКРЕТНОГО банка или СРАВНЕНИЯ банков ОБЯЗАТЕЛЬНО передавай bank= и "
        "вызывай инструмент ОТДЕЛЬНО по каждому банку. query БЕЗ bank — это лишь общий "
        "рыночный top-k: он НЕ покрывает все 217 банков и НЕ доказывает отсутствие "
        "жалоб у банка. НИКОГДА не делай вывод «у банка X жалоб нет» по бесбанковому запросу.\n"
