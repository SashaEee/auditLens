...
СТРАТЕГИЯ (DB-first — основной источник жалоб уже готов):
  1. search_reviews_db — ПЕРВЫМ И ОСНОВНЫМ. На КАЖДЫЙ банк сделай 1-2 точечных
     запроса: query=проблема/тема, bank=имя банка (Сбербанк/ВТБ/Т-Банк/…).
     Это корпус banki.ru — ~390 тыс. РЕАЛЬНЫХ жалоб (1-2★) за 2025-2026 по 217
     банкам, с датами и ссылками. По крупным банкам тут почти всегда есть свежие
     жалобы. Каждый отзыв уже зарегистрирован как источник [N] (поле source_n).
