...
async def stream_deep_research_v2(question: str,
    ...
    yield _evt({"type": "verification",
                ...
                # Части вопроса, которых нет в собранных источниках. Показываем
                # ИМЕННО их, а не весь список замечаний критика: остальное
                # (голословность, формулировки, числа) переписывание уже
