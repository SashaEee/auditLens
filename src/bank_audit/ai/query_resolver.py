...
• Поле `topic_synonyms` — список из 8-15 ключевых SINGLE-WORD форм + 2-4 фраз.
  ...
  ⚠ ЗАПРЕЩЕНО ПОВТОРЯТЬ ОДИН И ТОТ ЖЕ СИНОНИМ. Каждый элемент массива
  УНИКАЛЕН. МАКСИМУМ 15 синонимов всего. Если не можешь придумать 15
  разных — верни 5-7, лучше меньше но уникальных. Зацикленный массив
  («доверенностям, доверенностям, доверенностям, …») недопустим — он
  ломает JSON-парсер.
