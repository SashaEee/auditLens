...
AGENT_TIMEOUT_SECONDS_DEFAULT = 360
...
class LoopholeSettings:
    ...
    classify_model: str = ""
    research_classify_batch_size: int = 10
    chat_model: str = ""
    nanobot_model: str = ""
    ...
    def load(cls) -> LoopholeSettings:
        ...
        return cls(
            ...
            research_classify_batch_size=_load_positive_int(
                "LOOPHOLE_RESEARCH_CLASSIFY_BATCH_SIZE", 10, "batch classifier"
            ),
