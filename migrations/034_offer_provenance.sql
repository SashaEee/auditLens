...
-- NB: exec_driver_sql принимает % за placeholder — в LIKE-шаблонах и
-- комментариях процент удваивается ('%%'), иначе миграция падает молча
-- и деплой обрывается на set -e (поймано 11.08.2026).
